...
class GramediaSocratesAllBranchesSeeder extends Seeder
{
    private const KEYWORD = 'socrates';
    ...
    public function run(): void
    {
        ...
        foreach ($products as $row) {
            ...
            $this->syncSubjects($biblio, $titleRaw, $description, 'Socrates');
    ...
    private function downloadCover(string $url, string $title): ?string
    {
        try {
            ...
            $file = 'covers/gramedia-socrates-' . Str::slug($title) . '-' . Str::lower(Str::random(6)) . '.' . $ext;
