...
class StoreBiblioRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'copies_count' => ['nullable', 'integer', 'min:0', 'max:200'],
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($autoFix) {
            ...
            if ($this->has('language')) {
                ...
                $prepared['language'] = $lang !== '' ? $lang : null;
            }
            if ($this->has('isbn')) {
    ...
    protected function passedValidation(): void
    {
        try {
            ...
            Log::info('Cover upload (formrequest store) debug', [
            ...
            Log::warning('Cover upload (formrequest store) debug failed: ' . $e->getMessage());
        }
    }
    ...
    {
        try {
            Log::warning('Cover upload (formrequest store) validation failed', [
