...
<div class="nb-container" style="max-width:1100px;">
  <div class="nb-card rp-card">
    <div class="rp-head">
      <div>
        <div class="rp-title">Laporan Denda</div>
        <div class="rp-sub">Data denda berdasarkan transaksi peminjaman. Pembaruan: {{ now()->format('d M Y H:i') }}</div>
      </div>
    </div>
    ...
    <form method="GET" action="{{ route('transaksi.denda.index') }}" class="rp-filter">
      <div class="rp-row">
        ...
        <div class="rp-field w130">
          <label>&nbsp;</label>
          <button class="nb-btn is-primary rp-btn" type="submit">Terapkan</button>
        </div>
      </div>
      ...
      <table>
        <thead>
          <tr>
            ...
            <th style="width:180px;">Tanggal<span class="th-sub">Due / Returned</span></th>
            <th style="width:86px; text-align:center;">Telat</th>
            <th style="width:110px; text-align:right;">Total</th>
            <th style="width:110px; text-align:right;">Dibayar</th>
        ...
        <tbody>
          @forelse($rows as $r)
            ...
            <tr>
              ...
              <td>
                <div class="rp-mono">{{ $r['loan_code'] ?? '-' }}</div>
              </td>
              <td>
              ...
              <td>
                @if(!empty($r['loan_id']))
                  <a class="nb-btn rp-mini" href="{{ route('transaksi.riwayat.detail', ['id' => $r['loan_id']]) }}">Detail</a>
                @else
...
<style>
  ...
  .rp-btn{ width:100%; border-radius:12px; padding:9px 10px; }
  ...
  .rp-mini{ padding:6px 10px; border-radius:12px; font-size:12px; }
</style>
@endsection
