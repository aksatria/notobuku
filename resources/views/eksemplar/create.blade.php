...
@section('title', 'Tambah Eksemplar • NOTOBUKU')
...
@php
  ...
  $oldBranch = (string) old('branch_id', '');
  $oldShelf  = (string) old('shelf_id', '');
  ...
  $statusDefault = old('status', 'available');

  // Ringkasan untuk create (belum ada item)
  $sumBarcode = trim((string)old('barcode', ''));
  $sumStatus  = $statusLabels[$statusDefault] ?? 'Tersedia';
@endphp

<style>
/* =========================================================
   NOTOBUKU • EKSEMPLAR • CREATE (SAMA DENGAN EDIT)
...
<div class="ex-wrap">
  <div class="nb-card ex-shell">
    ...
    <div class="ex-head">
      <div>
        <h1 class="title">Tambah Eksemplar</h1>
        <div class="nb-muted-2 sub">
          Bibliografi: <b>{{ $biblio->display_title ?? $biblio->title ?? '-' }}</b>
        </div>
      </div>
      <a href="{{ route('eksemplar.index', $biblio->id) }}" class="nb-btn">Kembali</a>
    </div>

    <form method="POST" action="{{ route('eksemplar.store', $biblio->id) }}">
      @csrf
      ...
      <div class="ex-layout">
        ...
        <div>
          ...
          <div class="ex-section acc-blue">
            ...
            <div class="ex-grid-2">
              <div class="ex-field">
                <label>Barcode</label>
                <input class="nb-field" name="barcode" value="{{ old('barcode') }}"
              ...
              <div class="ex-field">
                ...
                <input class="nb-field" name="accession_number" value="{{ old('accession_number') }}"
                       placeholder="Kosongkan untuk otomatis">
            ...
            <div class="ex-grid-2" style="margin-top:12px;">
              <div class="ex-field">
                ...
                <input class="nb-field" name="inventory_code" value="{{ old('inventory_code') }}"
              ...
              <div class="ex-field">
                ...
                <input class="nb-field" name="inventory_number" value="{{ old('inventory_number') }}"
                       placeholder="Opsional">
          ...
          {{-- Status & Kondisi (sama seperti Edit) --}}
          <div class="ex-section acc-green">
            ...
            <div class="ex-grid-3">
              ...
              <div class="ex-field">
                ...
                <input class="nb-field" name="condition" value="{{ old('condition') }}"
              ...
              <div class="ex-field">
                <label>Catatan</label>
                <input class="nb-field" name="notes" value="{{ old('notes') }}"
                       placeholder="Opsional">
            ...
            <div class="ex-grid-3" style="margin-top:12px;">
              <div class="ex-field">
                ...
                <input class="nb-field" type="date" name="acquired_at"
          ...
          <div class="ex-section acc-slate">
            ...
            <div class="ex-grid-3">
              ...
              <div class="ex-field">
                ...
                <input class="nb-field" name="location_note" value="{{ old('location_note') }}"
                       placeholder="Opsional">
          ...
          <div class="ex-actions">
            <button class="nb-btn nb-btn-primary" type="submit">Simpan Eksemplar</button>
        ...
        <div class="ex-side">
          ...
          <div class="ex-section acc-slate">
            ...
            <div class="ex-kpi">
              <div class="row"><span>ID Eksemplar</span><span class="v">(baru)</span></div>
              <div class="row"><span>Barcode</span><span class="v">{{ $sumBarcode !== '' ? $sumBarcode : '(otomatis)' }}</span></div>
          ...
          <div class="ex-section acc-blue" style="margin-top:12px;">
            ...
            <div class="nb-muted-2" style="font-size:12.5px; line-height:1.55; font-weight:400;">
              • Biarkan <b>barcode</b> kosong untuk otomatis.<br>
              • Pilih <b>cabang</b> dulu agar daftar <b>rak</b> tersaring.<br>
              • Status awal disarankan <b>Tersedia</b>.
            </div>
          </div>
