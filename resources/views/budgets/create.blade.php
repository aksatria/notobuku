...
<div class="saas-page">
  <div class="saas-card">
    <div class="saas-head">
      <div>
        <h1 class="saas-title">Tambah Budget</h1>
        <div class="saas-sub">Input alokasi budget tahunan.</div>
      </div>
      <a class="nb-btn" href="{{ route('acquisitions.budgets.index') }}">Kembali</a>
    </div>

    <form method="POST" action="{{ route('acquisitions.budgets.store') }}" style="margin-top:12px;">
      @csrf
      <div class="field" style="margin-bottom:10px;">
        <label>Tahun</label>
        <input class="nb-field" name="year" value="{{ now()->year }}">
      </div>
      <div class="field" style="margin-bottom:10px;">
      ...
      <div class="field" style="margin-bottom:10px;">
        <label>Amount</label>
        <input class="nb-field" type="number" step="0.01" name="amount" value="0">
      </div>
